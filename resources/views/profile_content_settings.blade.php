...
<main>
  ...
  <div id="profile-upper" class="cover-image">
    ...
    <div id="profile-d">
      ...
      <a href="{{route('change_image')}}" style="text-decoration:none;font-size: 11px;color:#0f71f1;">Change Profile</a> | 
<a href="{{route('change_cover')}}" style="text-decoration:none;color:#0f71f1;font-size: 11px;">Change Cover </a>
    ...
    <div class="tb" style="margin-bottom:50px;">
      ...
      <div class="td" id="m-col">
          ...
          <div class="tb">
            <div class="td">
              <div class="tb" id="p-tabs-m">
                <div class="td active"><a href="{{ route('timeline') }}" sty><span>TIMELINE</span></a></div>
       ...
       <div class="l-cnt l-mrg" style="border-radius: 20px;">
          ...
          <div id="photos" style="padding:20px;">
...
<div class="tb">
    ...
    <div class="tr">
        ...
        <div style= "justify-content: center;display: flex;padding:8px;">
        <form action="{{route('settings')}}" method="post">
@csrf

         <label for="first_name">First Name</label>
         <input type="text" name="first_name" value="{{$user->first_name}}" style="height: 30px;width: 500px;border-radius: 10px;">
         <br>
         <label for="first_name">Last Name</label>
         <input type="text" name="last_name" value="{{$user->last_name}}" style="height: 30px;width: 500px;border-radius: 10px;">
         <br>

         <label for="first_name">Gender</label>
        
         <select name="gender" id="gender" style="width: 500px; height: 30px;">
         ...
         <input type="text" name="email" value="{{$user->email}}" style="height: 30px;width: 500px;border-radius: 10px;">
         <br>

         <label for="first_name">Password</label>
         <input type="text" name="password1" value="{{$user->password}}" style="height: 30px;width: 500px;border-radius: 10px;">

         <br>


         <label for="first_name">Password2</label>
         <input type="text" name="password2" value="{{$user->password}}" style="height: 30px;width: 500px;border-radius: 10px;">

         <br><br>
         <input type="submit" name="submit" value="submit" style="background:blue;color:#FFF;padding:8px;border-radius:8px;">
        </form>
        </div>
