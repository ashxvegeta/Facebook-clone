...
<input type="text" name="designation"  placeholder="Designation" style="width: 100%;height: 35px;">
<br><br>
<input type="text" name="Tell"  placeholder="Tell about Youself" style="width: 100%;height: 35px;">
<br><br>
<input type="text" name="city" placeholder="city" style="width: 100%;height: 35px;" >
<br><br>
<input type="submit" value="Save" style="background-color:rgba(40, 0, 255, 1);padding: 5px;color: white;">
