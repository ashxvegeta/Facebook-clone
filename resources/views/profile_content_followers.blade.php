...
<head>
  ...
  overflow: hidden;
    ...
    input::placeholder {
        color: #FF5733;
        /* This is an example color; you can change it to any color you prefer */
    }
    ...
    <main>
        ...
        <header>
            <div class="tb">
                <div class="td" id="logo">
                    <a href="#"
                        style="color:#0f71f1;font-size:30px;background-color:white;padding:5px;border-radius: 5px;"><i
                            class=""></i>Chatbook</a>
                </div>
        ...
        <div id="profile-upper" class="cover-image">
            ...
            <div id="profile-d">
                ...
                <a href="{{route('change_image')}}" style="text-decoration:none;font-size: 11px;color:#0f71f1;">Change
                    Profile</a> |
                <a href="{{route('change_cover')}}" style="text-decoration:none;color:#0f71f1;font-size: 11px;">Change
                    Cover </a>
                <div id="u-name">{{$user->first_name}} {{$user->last_name}}
                    <a href="{{route('follow',['type'=>'user','id'=>$user->email])}}"
                        style="text-decoration:none;color:white;"><span
                            style="font-size: large; background: blue;padding:8px;border-radius: 4px;"><i
                                class="fa fa-plus-square" aria-hidden="true"></i> Follow</span></a> <br>
                    @php
                    $mylikes = "";
                    if($user->likes>0){
                    $mylikes = $user->likes;
                    ...
                    @endphp
                    <small style="font-size: 15px;">{{$mylikes}} followers</small>
                </div>
        ...
        <div id="main-content">
            <div class="tb" style="margin-bottom:50px;">
                <div class="" id="">
          ...
          <div id="cpy-nt">Facebook &copy; <span id="curr-year"></span></div> -->
                ...
                <div class="td" id="m-col">
                    <div class="m-mrg" id="p-tabs" style="height:50px;border-radius: 10px;margin-left:300px;">
                        <div class="tb">
                            <div class="td">
                                <div class="tb" id="p-tabs-m">
                                    <div class="td active"><a href="{{ route('timeline') }}"
                                            sty><span>TIMELINE</span></a></div>
                                    <div class="td"><span>FRIENDS</span></div>
                                    <div class="td"><span><a
                                                href="{{route('navbarmenu',['section'=>'photos','id'=>$user->email])}}">PHOTOS</a></span>
                                    </div>
                                    <div class="td"><span>ABOUT</span></div>
                                    <div class="td"><span><a
                                                href="{{route('navbarmenu',['section'=>'follow','id'=>$user->email])}}">FOLLOWERS</a></span>
                                    </div>
                                    <div class="td"><span><a
                                                href="{{route('navbarmenu',['section'=>'following','id'=>$user->email])}}">FOLLOWING</a></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="l-cnt l-mrg" style="border-radius: 20px;">
                        <div class="cnt-label">
                            ...
                            <!-- <div class="tb">
                                <div class="tr">
                                    ...
                                    <div class="flex-container">
                                        <div><img src="photo/{{ $data['profile_image'] }}"
                                                style="height:100px;width:150px;border-radius:10px;"></div>
                                    ...
                                    @else
                                    <div class="flex-container">
                                        <div> <span> This user is't follow anyone </span></div>
                                    </div>
                                    @endif
                                </div>
                            </div> -->
                            ...
                            <div id="editintroModal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="">
                                        ...
                                        <br><br>
                                        <input type="text" name="Tell" placeholder="Tell about Youself"
                                            style="width: 100%;height: 35px;">
                                        <br><br>
                                        ...
                                        <input type="submit" value="Save"
                                            style="background-color:rgba(40, 0, 255, 1);padding: 5px;color: white;">
